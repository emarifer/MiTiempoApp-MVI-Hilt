...
constructor(
    ...
    suspend fun execute(locality: String): Flow<List<Forecast>> = flow {
 ...
 * Recupera los objetos forecast desde caché (fuente única de confianza)
 * Emite, a través del flow, la lista de objetos forecast para que se muestre en la UI
 */